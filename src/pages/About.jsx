          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 shadow-2xl p-7 py-10 bg-muted/50 rounded-3xl items-center">
            ...
            <div className="lg:w-1/2 ">
              ...
              <p className="text-[1.4rem] lg:text-[1.7rem] tracking-wider leading-relaxed sm:max-w-4xl lg:max-w-5xl mb-8 ">
                ...
                <p className="my-7">
                  What started as a small community gym quickly grew into a
                  place of transformation — not just of bodies, but of
                  confidence, mindset, and lifestyle. From the first weights
                  lifted to the friendships formed, every moment here is powered
                  by passion and progress.
                </p>
                At CoreFit, we believe in energy, encouragement, and growth.
                We’re more than just a gym — we’re a family that pushes,
                supports, and celebrates every milestone with you.
              </p>
